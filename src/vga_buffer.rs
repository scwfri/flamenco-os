...
#[repr(C)] // guarantee correct filed ordering by using C struct layout
struct ScreenChar {
    ascii_character: u8,
...
pub struct Writer {
    ...
    color_code: ColorCode,
    buffer: &'static mut Buffer, // 'static => explicit lifetime.. this struct is valid for the lifetime of the program
}
